module.exports = {
  ...
  chart: {
    ...
    expectedSvgText: {
      argumentsLabelX: [
        { point: [30, 185], label: "4:0", groupFlag: true },
        { point: [38, 185], label: "4:15", groupFlag: true },
        { point: [46, 185], label: "3:45", groupFlag: true },
        { point: [54, 185], label: "3:45", groupFlag: true },
        { point: [62, 185], label: "3:45", groupFlag: true },
      ],
      argumentsLabelY: [
        { point: [30, 170], label: 1 },
        { point: [30, 142], label: 1.111 },
        { point: [30, 114], label: 1.222 },
        { point: [30, 86], label: 1.333 },
        { point: [30, 58], label: 1.444 },
      ],
    },
